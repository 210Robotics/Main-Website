    ...
    <section className="grid-bg min-h-[760px] py-20">
      <div className="shell grid items-start gap-12 lg:grid-cols-2">
        <div className="pt-8">
          ...
          <h1 className="display">Back to the build.</h1>
          ...
          <p className="mt-7 text-sm leading-7 text-[#999]">
            Email and password only. Every new account requires email
            verification and manual officer approval.
          </p>
        </div>
        <div className="flex justify-center lg:justify-end">
          {hasClerk() ? (
            <SignIn
              ...
              appearance={emailPasswordAppearance}
            />
          ) : (
            <ServiceNotice />
          )}
